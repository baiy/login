...
// | Author: qufo <qufo@163.com> 修正以符合 BootStrap 规范
// +----------------------------------------------------------------------
...
class Page {
	 ...
	 */
	public function __construct($totalRows, $listRows, $parameter = array(), $urltpl = '') {
	...
	public function show() {
		...
		if (!empty($this->urltpl)) {
			...
			$this->url[0] = $this->url[1] = U(ACTION_NAME, $this->parameter);
		}
		/* 计算分页信息 */
